...
The results are saved inside results/tinyvit/.
"""
...
from train_tiny_vit import TinyViT
...
# Final TinyViT checkpoint selected using validation loss.
MODEL_PATH = RESULTS_DIR / "best_tinyvit_V2.pt"

CONFUSION_MATRIX_PATH = (
    RESULTS_DIR / "confusion_matrix_tinyvit.png"
)

REPORT_PATH = (
    RESULTS_DIR / "classification_report_tinyvit.txt"
)
...
def save_confusion_matrix(
    ...
    axis.set_title(
        "TinyViT-style confusion matrix"
    )
...
def main() -> None:
    """Evaluate the selected TinyViT checkpoint."""
